<?php
  ...
  $_SESSION["act_page"] = "priv_del_user_list";
...
<html>
  ...
  ?>
      ...
      <span class="crumbTrail"><a class="crumbTrail" href="../User/sti_library.php">STI-Innsbruck Library</a> &gt; <a class="crumbTrail" href="priv_func_overview.php">Privileged functions</a> &gt; <a class="crumbTrail" href="del_user_search.php">Delete user - Search & list</a> &gt; User list </span>
          ...
          <table cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
              <td>
                ...
                <h2>Delete user - User list</h2><br>
                ...
                <?php
                  ...
                  $string = "";
                  if (isset($_SESSION["del_user_string"]))
                    $string = $_SESSION["del_user_string"];
                  ...
                  if (!$noSearch) {
                    ...
                    $_SESSION["act_del_user_page"] = "list";
                    $_SESSION["del_user_string"] = $sqlSelectUser;
                    ...
                    if ($num > 0){
                      ...
                      for ($i=0; $i<$num; $i++)
                      {
                        ...
                        echo "<td> <a href='del_user.php?uid=$uid'> $user_name </td>";
                        echo "<td> $email </td> </tr>";
                      } // end for
