<?php
  ...
  $_SESSION["act_page"] = "expert_detail";
...
<html>
  ...
  ?>
      ...
      <span class="crumbTrail"><a class="crumbTrail" href="sti_library.php">STI-Innsbruck Library</a> &gt; <a class="crumbTrail" href="expert_search.php">Expert search</a> &gt; <a class="crumbTrail" href="expert_result_list.php?get_back=getBack">Search result</a> &gt; Detail information</span>
            ...
            <tr>
              <td>
                ...
                <?php
                  ...
                  $_SESSION["prev_page"]= "expert_obj_detail.php";
