<?php
  ...
  $_SESSION["act_page"] = "priv_del_obj_search";
...
<html>
  ...
  ?>
      ...
      <span class="crumbTrail"><a class="crumbTrail" href="../User/sti_library.php">STI-Innsbruck Library</a> &gt; <a class="crumbTrail" href="priv_func_overview.php">Privileged functions</a> &gt; <a class="crumbTrail" href="del_obj_search.php">Delete object - Search & list</a></span>
          ...
          <table cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
              <td>
                ...
                <h2>Delete object - Object search</h2><br>

                <table cellpadding="0" cellspacing="5" border="0" width="70%">

                  <form action = "del_obj_list.php" method = "post">
                    <tr>
                ...
                <?php
                  ...
                  $_SESSION["act_del_obj_page"] = "search";
                  ...
                  if ($num > 0) {
                    ...
                    echo "<br><br> No objects found! <br><br>";
