<?php
  ...
  $_SESSION["act_page"] = "help_add_obj";
...
<html>
  ...
  ?>
      ...
      <span class="crumbTrail"><a class="crumbTrail" href="../User/sti_library.php">STI-Innsbruck Library</a> &gt; <a class="crumbTrail" href="help.php">Help</a> &gt; <a class="crumbTrail" href="priv_functions_help.php">Privileged functions help</a> &gt; <a class="crumbTrail" href="add_obj_help.php">Add new object help</a></span>
          ...
          <table cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
              <td>
                ...
                <h3>Add new object help</h3>
                  <ul class="innerList">
                    <li>To add a new object, you need to be logged in and you need to have superuser rights. If you are not yet logged in to the system, you click on 'Privileged functions' on the menue left and log in.</li>
                    <li>Then you choose 'Add new object' either directly or from the menue left.</li>
                    <li>You get to a form, where you can enter the new object's detail information.</li>
                    ...
                    <li>To add the object, you need to click on 'Add object'. You now get a confirmation that you added this object to the database.</li>
                  </ul>
              </td>
            </tr>
          </table>
