<?php
  ...
  $_SESSION["act_page"] = "priv_del_user_search";
...
<html>
  ...
  ?>
      ...
      <span class="crumbTrail"><a class="crumbTrail" href="../User/sti_library.php">STI-Innsbruck Library</a> &gt; <a class="crumbTrail" href="priv_func_overview.php">Privileged functions</a> &gt; <a class="crumbTrail" href="del_user_search.php">Delete user - Search & list</a> </span>
            ...
            <tr>
              <td>
                ...
                <?php
                  ...
                  $_SESSION["act_del_user_page"] = "search";
                  ...
                  if ($num > 0) {
                    ...
                    echo "</table>";
                      ...
                      echo "<br><br> No user found <br><br>";
