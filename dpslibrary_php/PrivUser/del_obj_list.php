<?php
  ...
  $_SESSION["act_page"] = "priv_del_obj_list";
...
<html>
  ...
  ?>
      ...
      <span class="crumbTrail"><a class="crumbTrail" href="../User/sti_library.php">STI-Innsbruck Library</a> &gt; <a class="crumbTrail" href="priv_func_overview.php">Private functions overview</a> &gt; <a class="crumbTrail" href="del_obj_search.php">Delete object - Search & list</a> &gt; Object list </span>
          ...
          <table cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
              <td>
                ...
                <h2>Delete object - Object list</h2><br>
                ...
                <?php
                  ...
                  $string = "";
                  if (isset($_SESSION["del_obj_string"]))
                    $string = $_SESSION["del_obj_string"];
                  ...
                  if (!$noSearch) {
                    ...
                    $_SESSION["act_del_obj_page"] = "list";
                    $_SESSION["del_obj_string"] = $sqlSelectObj;
                    ...
                    if ($num > 0){
                      ...
                      for ($i=0; $i<$num; $i++)
                      {
                        ...
                        echo "<td> <a href='del_obj.php?pid=$pid'> $title </a> </td>";
                        echo "<td> $author </td>";
                        echo "<td> $year </td>";
                        echo "<td> <a href='del_obj.php?pid=$pid'> $signature </a ></td>";
                        echo "<td> $status </td>";
                        echo "</tr>";
                      } // end for
                      echo "</table>";
